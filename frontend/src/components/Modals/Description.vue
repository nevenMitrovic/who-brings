  ...
  >
    ...
    <div class="fixed inset-0 z-10 w-screen overflow-y-auto">
      ...
      >
        ...
        >
          <div class="p-2">
            <div class="text-xl py-2">Edit description</div>
            <textarea
              id="message"
              name="message"
              class="border"
...
const updateDescription = (list: any) => {
  list.description = description.value;

  listsService
    .updateList(props.list._id, list)
    .then((res) => commonStore.toggleDescriptionModal());
};
</script>
